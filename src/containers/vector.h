...
* @param[in] element A pointer to the element to insert. There must be at least as many bytes readable
* as the stride passed to the @ref vect_init call.
...
*
* This is a convenience function to avoid copying elements around. Be careful not to overwrite other
* elements, as no mechanism ensures memory safety inside a vector !
*
* @param[inout] vector The vector to query.
