...
*** BUG All bytes of a packet are read correctly, but ~has_read_all_bytes()~ aborts the program.
...
*** TODO Abstraction over Linux and Windows sockets
*** TODO Windows implementation of the main network loop
